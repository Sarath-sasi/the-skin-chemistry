           ...
           <div class="inner-banner-image">
                ...
                <div class="container">
                       <div class="banner-content">
                           <h2 class="head text-white mb-2">FAQ</h2>
...
<section class="sc-antiaging-sec position-relative about-antiaging-sec">
    ...
    <div class="container">
           <h2 class="head text-primary mb-4">FREQUENTLY ASKED QUESTIONS</h2>
           <div class="accordion faq-accordion mw-100" id="accordionExample">
