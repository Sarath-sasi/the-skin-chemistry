...
<section class="inner-banner">
    <div class="inner-banner-image">
        <img src="assets/images/gallery/gallery-banner.png" />
        <div class="container">
            <div class="banner-content">
                <h2 class="head text-white mb-2">Gallery</h2>
            ...
            <div class="gallery-item-wrapper">
                <div class="row">
                    <div class="col-6 col-lg-3">
                        <a href="./assets/images/gallery/image-l.jpg" class="gallery-wrapper image-s image-rounded glightbox">
                    ...
                    <div class="col-6 col-lg-3">
                        ...
                        <a href="./assets/images/gallery/image-l.jpg" class="gallery-wrapper image-s rounded glightbox">
                            <div class="gallery-image">
                                <div class="gallery-container">
                                    <img src="./assets/images/gallery/image-l.jpg" alt="">
                                </div>
